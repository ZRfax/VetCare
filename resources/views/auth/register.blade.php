    ...
    <div class="max-w-md mx-auto w-full px-4 sm:px-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
            ...
            <form action="{{ route('register') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" placeholder="Juan Pérez"
                               class="w-full border border-slate-200 rounded-lg pl-9 pr-4 py-2.5 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:border-transparent placeholder-slate-400 @error('name') border-red-400 @enderror" required>
                    </div>
                    @error('name')
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" placeholder="tu@email.com"
                               class="w-full border border-slate-200 rounded-lg pl-9 pr-4 py-2.5 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:border-transparent placeholder-slate-400 @error('email') border-red-400 @enderror" required>
                    </div>
                    @error('email')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                {{-- Phone (optional) --}}
                <div>
                    <label class="block text-sm font-medium text-slate-700 mb-1">Teléfono <span class="text-slate-400 font-normal">(opcional)</span></label>
                    <div class="relative">
                        <span class="absolute inset-y-0 left-3 flex items-center pointer-events-none">
                            <svg class="w-4 h-4 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <input type="tel" name="telefono" value="{{ old('telefono') }}" placeholder="9673-6956"
                               class="w-full border border-slate-200 rounded-lg pl-9 pr-4 py-2.5 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:border-transparent placeholder-slate-400 @error('telefono') border-red-400 @enderror">
                    </div>
                    @error('telefono')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password" id="password" placeholder="••••••••"
                               class="w-full border border-slate-200 rounded-lg pl-9 pr-10 py-2.5 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:border-transparent placeholder-slate-400 @error('password') border-red-400 @enderror" required>
